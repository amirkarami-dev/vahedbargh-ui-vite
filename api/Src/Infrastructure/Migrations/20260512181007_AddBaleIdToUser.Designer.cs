...
namespace Coreapi.Infrastructure.Migrations
{
    ...
    [Migration("20260512181007_AddBaleIdToUser")]
    partial class AddBaleIdToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coreapi.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("IntegrateId")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<bool>("IsAdminSupport")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("IntegrateId")
                        .IsUnique()
                        .HasFilter("[IntegrateId] IS NOT NULL");
