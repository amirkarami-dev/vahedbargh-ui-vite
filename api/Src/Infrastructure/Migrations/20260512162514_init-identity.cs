        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntegrateId = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    IsAdminSupport = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IntegrateId",
                table: "AspNetUsers",
                column: "IntegrateId",
                unique: true,
                filter: "[IntegrateId] IS NOT NULL");
