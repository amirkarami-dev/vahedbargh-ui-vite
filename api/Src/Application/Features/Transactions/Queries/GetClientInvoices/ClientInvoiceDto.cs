...
{
    public class ClientInvoiceDto :IMapFrom<Invoice>
    {
    ...
    public long EngineerNaCode { get; set; }
    ...
    {
        profile.CreateMap<Invoice, ClientInvoiceDto>()
            ...
            .ForMember(destination=>destination.EngineerName,
                otp=>otp.MapFrom(source=>source.ElectProjectProcess.Engineer.FullName))
            .ForMember(destination => destination.EngineerNaCode,
                otp => otp.MapFrom(source => source.ElectProjectProcess.Engineer.NaCode))
