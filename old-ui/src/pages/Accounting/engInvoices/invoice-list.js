...
const InvoiceEngList = props => {
  ...
  useEffect(() => {
    props.onGetInvoices(getCurrentUser().sid)
  }, [])
  return (
    <>
      <Box
...
const mapDispatchToProps = dispatch => ({
  onGetInvoices: (engId) => dispatch(getEngInvoices(engId)),
})

export default connect(mapStateToProps, mapDispatchToProps)(InvoiceEngList)
