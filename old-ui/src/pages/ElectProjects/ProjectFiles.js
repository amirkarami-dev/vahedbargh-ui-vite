      ...
      >
        ...
        <DialogTitle>
          ...
          <DialogContent>
            ...
            {(rowData.projectLevelEnum !== 2  || getCurrentUser().role ==='Administrator' || getCurrentUser().role ==='Section') && <Box>
          ...
          <DialogActions>
            <Box sx={{ display: "flex" }}>
              {mainProps.loading ? (
                ...
                <Button disabled={(getCurrentUser().role !=='Administrator' && getCurrentUser().role !=='Section'  )} variant="contained" type="submit">
                  ذخیره
                </Button>
              )}
            </Box>
