...
import ElectProjects from "./report"
import ElectGCityProjects from "./reportGCity"
...
const Reports = props => {
  ...
  const tabNames = ["پرونده های ثبت شده","گروه بندی شهرستان"]
        ...
        <Container   maxWidth="xl">
          ...
          >
            ...
            <TabPanel value={value} index={0}>
              <ElectProjects translate={t} />
            </TabPanel>
            <TabPanel value={value} index={1}>
              {/* <ElectGCityProjects translate={t} /> */}
            </TabPanel>
          </Box>
        </Container>
      </div>
