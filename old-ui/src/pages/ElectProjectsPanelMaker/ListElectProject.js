...
const mapDispatchToProps = dispatch => ({
  ...
  onAddFileElectProjectSingle: attachData => dispatch(addFileElectProjectSingle(attachData)),
  ...
  onSelectElectProject: (gpId, selectArr) => dispatch(selectGp(gpId, selectArr)),
  onDeselectElectProject: () => dispatch(deselectGp()),
  onSubmitElectProjectByAdmin: electProjectId => dispatch(submitElectProjectAdmin(electProjectId)),
  ...
  onPanelSubmit: id => dispatch(submitPanel(id))
})
