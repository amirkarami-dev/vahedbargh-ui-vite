...
const ProjectFileNumber = ({ rowData, mainProps }) => {
    const style = {
    ...
    const [formInput, setFormInput] = useReducer(
      (state, newState) => ({ ...state, ...newState }),
      {
        ...
        buildingTypeEnum: rowData.buildingTypeEnum,
    ...
    useEffect(()=>{
      if(+dataAddress.sectionId !== 0 && +dataAddress.sectionId !== rowData.idSection ) setFormInput({address:""})
          ...
          <form onSubmit={handleSubmitForm}>
            ...
            <Grid item xs={12}>
              ...
              <Grid container justifyContent="center" alignItems="center">
                <Grid item xs={4}>
                  <span>نوع لوله کشی:</span>{" "}
                  {mainProps.t("project." + rowData.pipingType)}
                </Grid>
                <Grid item xs={4}>
                  <span>مالکیت:</span> {mainProps.t(rowData.ownershipType)}
                </Grid>
                <Grid item xs={4}>
                ...
                >
                  ...
                  <Grid item sx={{ paddingTop: 2 }} xs={6}>
                    <FormControl size="small" fullWidth disabled>
                      <InputLabel id="select-label-buildingTypeEnum">
                        نوع کاربری
                      </InputLabel>
                      <Select
                        labelId="select-label-buildingTypeEnum"
                        name="buildingTypeEnum"
                        value={formInput.buildingTypeEnum}
                        label="نوع کاربری"
                        onChange={handleInput}
                      >
                  ...
                  <Grid  item xs={12}>
                              <Locations setDataAddress={setDataAddress} matches_sm={true} idSection={rowData.idSection} />
                            </Grid>
...
export default ProjectFileNumber