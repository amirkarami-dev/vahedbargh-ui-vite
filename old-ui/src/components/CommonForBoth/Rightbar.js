        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            <div className="rightbar-title px-3 py-4">
              ...
              <h5 className="m-0">تنظیمات تم</h5>
            </div>
            ...
            <div className="p-4">
              ...
              <div className="radio-toolbar">
                ...
                />
                <label htmlFor="radioThemeLight">حالت روز</label>
                {"   "}
                <input
                  type="radio"
                  id="radioThemeDark"
                ...
                <label htmlFor="radioThemeDark">حالت شب</label>
                {"   "}
              </div>
              ...
              {props.layoutType === "vertical" ? (
                <React.Fragment>
                  ...
                  <div className="radio-toolbar">
                    ...
                    />
                    <label htmlFor="sidebarDefault">پیش فرض</label>
                    {"   "}
                    <input
                      type="radio"
                      id="sidebarCompact"
                  ...
                  <div className="radio-toolbar">
                    ...
                    <label htmlFor="leftsidebarThemelight">روشن</label>
                    {"   "}
                    <input
                      type="radio"
                    ...
                    <label htmlFor="leftsidebarThemedark">تاریک</label>
                    {"   "}
                    <input
                      type="radio"
                    ...
                    <label htmlFor="leftsidebarThemecolored">رنگی</label>
                  </div>
                  <hr className="mt-1" />
                </React.Fragment>
              ) : null}
