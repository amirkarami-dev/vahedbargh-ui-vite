...
const projects = [
  {
    ...
    files: [
      { name: "electUnit Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "electUnit Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "electUnit Logo.Zip", size: "2.02 MB", link: "#" },
      { name: "electUnit admin.Zip", size: "2.25 MB", link: "#" },
    ],
    comments: [
      {
        id: 1,
